...
Den 9 september 2026 fylls i lobbytrenden med ett uttryckligen godkänt estimat: snittet av de uppmätta dygnsvärdena den 8 och 10 september. `estimatedDates`, punktens `estimated` och `dailyQuality` anger ursprung och grann-datum. Grafen märker värdet som uppskattat. Rådata, spelsnitt och täckningsstatus ändras inte av estimatet. Det räknas om från grann-dagarna och ersätts av uppmätt data om dagen senare blir komplett.
