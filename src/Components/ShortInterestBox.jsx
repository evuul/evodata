...
const ShortInterestBox = ({ shortPercent = 5.2, totalShares }) => {
  const clamped = Math.max(0, Math.min(100, shortPercent));
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption" sx={{ color: "#808080", display: "block", mt: 1 }}>
        Källa: Offentliga blankningsregister (senast uppdaterad uppskattning)
      </Typography>
    </Card>
  );
};
