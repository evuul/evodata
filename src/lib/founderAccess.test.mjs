...
import { findFounderAccess, isFounderEmail, normalizeHistoryDays } from "./founderAccess.js";
...
test("limits extended history to Founder accounts", () => {
  ...
  assert.equal(normalizeHistoryDays(365, { isFounder: true }), 365);
  assert.equal(normalizeHistoryDays(2, { isFounder: true }), 7);
});
