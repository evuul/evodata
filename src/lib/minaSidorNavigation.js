...
export function normalizeMinaSidorView(value, { isAdmin = false } = {}) {
...
export function buildMinaSidorViewHref({ pathname = "/mina-sidor", search = "", view } = {}) {
  const params = new URLSearchParams(search);
  const normalizedView = normalizeMinaSidorView(view, { isAdmin: view === "admin" });
